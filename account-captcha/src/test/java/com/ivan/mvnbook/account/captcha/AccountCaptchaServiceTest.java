package com.ivan.mvnbook.account.captcha;
...
public class AccountCaptchaServiceTest {
	...
	public void testGenerateCaptcha() throws Exception {
		...
		byte[] captchImage = service.generateCaptchaImage(captchaKey);
		assertTrue(captchImage.length > 0);
